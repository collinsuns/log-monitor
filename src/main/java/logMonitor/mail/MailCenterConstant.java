...
public class MailCenterConstant {
    ...
    public final static String FROM_ADDRESS = "collinsuns@163.com";
    public final static String USER = "collinsuns@163.com";
    public final static String PWD = "1990212KEXU";
}
